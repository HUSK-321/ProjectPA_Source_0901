...
#include "CameraMode_ThirdPerson.h"
#include "PenetrationAvoidanceFeeler.h"
#include "ProjectPA/Interfaces/CameraAssistInterface.h"
...
void UCameraMode_ThirdPerson::UpdateView(float DeltaTime)
{
...
void UCameraMode_ThirdPerson::PreventCameraPenetration(AActor const& ViewTarget, FVector const& SafeLoc,
...
void UCameraMode_ThirdPerson::SetTargetCrouchOffset(FVector NewTargetOffset)
{
...
void UCameraMode_ThirdPerson::UpdateCrouchOffset(float DeltaTime)
{
